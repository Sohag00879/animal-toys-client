      ...
      <div className="hero-content flex-col lg:flex-row">
        ...
        <div>
          ...
          <p className="py-6">
            ...
            <br /> Filled to the brim with variety, this tube holds 12 different
            sea creatures like sharks, penguins, and the world is coolest
            crustacean, the lobster!
          </p>
          <p className="mb-4">
            <span className="text-red-600 font-semibold">Fun Fact:</span> <br />
            How fast can a starfish run? About as fast as a snail, so they are
